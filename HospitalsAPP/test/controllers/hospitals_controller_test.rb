...
class HospitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hospital" do
    assert_difference("Hospital.count") do
      post hospitals_url, params: { hospital: { haddress: @hospital.haddress, hid: @hospital.hid, hname: @hospital.hname, hphone: @hospital.hphone } }
    end
  ...
  test "should update hospital" do
    patch hospital_url(@hospital), params: { hospital: { haddress: @hospital.haddress, hid: @hospital.hid, hname: @hospital.hname, hphone: @hospital.hphone } }
