...
class MedicalCardsControllerTest < ActionDispatch::IntegrationTest
  setup do
  ...
  test "should create medical_card" do
    assert_difference("MedicalCard.count") do
      post medical_cards_url, params: { medical_card: { diagnosis: @medical_card.diagnosis, doctor_id: @medical_card.doctor_id, hospital_id: @medical_card.hospital_id, medical_card_id: @medical_card.medical_card_id, patient_id: @medical_card.patient_id } }
    end
  ...
  test "should update medical_card" do
    patch medical_card_url(@medical_card), params: { medical_card: { diagnosis: @medical_card.diagnosis, doctor_id: @medical_card.doctor_id, hospital_id: @medical_card.hospital_id, medical_card_id: @medical_card.medical_card_id, patient_id: @medical_card.patient_id } }
